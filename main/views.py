...
def hello(request):
    if request.user.is_authenticated:
        ...
        return render(request, "main/index.html", {"solved_tasks": sorted(solved_serializer.data, reverse=True),
                                                   "unsolved_tasks": sorted(unsolved_serializer.data, reverse=True)})
    else:
